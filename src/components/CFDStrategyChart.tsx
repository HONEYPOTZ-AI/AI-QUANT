...
const CustomSignalDot = (props: any) => {
  ...
  // Create short commentary (max 40 chars)
  const shortCommentary = signal.commentary.length > 40 
    ? signal.commentary.substring(0, 37) + '...' 
    : signal.commentary;
