  ...
  return (
    <div className="container mx-auto p-4 md:p-6 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Options Greeks & P&L Attribution</h1>
      ...
      <Tabs defaultValue="greeks" className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Select Greeks to display</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {['Delta', 'Gamma', 'Theta', 'Vega', 'Rho'].map((greek) => (
                  <div key={greek} className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor={greek} className="cursor-pointer">
                      {greek}
                    </Label>
                  </div>
                ))}
        ...
        <TabsContent value="attribution" className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle>About P&L Attribution</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              <p>
                <strong>Delta P&L:</strong> Profit/loss from changes in the underlying asset price.
                This is the most significant component for directional trades.
              </p>
              <p>
                <strong>Gamma P&L:</strong> Profit/loss from changes in delta as the underlying moves.
                This captures the convexity/curvature effect of options.
              </p>
              <p>
                <strong>Theta P&L:</strong> Profit/loss from time decay. Typically negative for long options
                and positive for short options.
              </p>
              <p>
                <strong>Vega P&L:</strong> Profit/loss from changes in implied volatility.
                Important for volatility trading strategies.
              </p>
              <p>
                <strong>Rho P&L:</strong> Profit/loss from interest rate changes.
